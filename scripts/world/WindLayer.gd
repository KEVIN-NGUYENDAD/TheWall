...
func _draw() -> void:
	for s in streaks:
		...
		draw_circle(pos, r, Color(COLOR.r, COLOR.g, COLOR.b, COLOR.a), true, -1.0, true)
		draw_circle(pos - Vector2(r * 1.1, 0.0), r * 0.75, Color(COLOR.r, COLOR.g, COLOR.b, COLOR.a * 0.7), true, -1.0, true)
		draw_circle(pos - Vector2(r * 2.0, 0.0), r * 0.45, Color(COLOR.r, COLOR.g, COLOR.b, COLOR.a * 0.4), true, -1.0, true)
